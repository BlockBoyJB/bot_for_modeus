...
func (p *parser) SemesterTotalGrades(ctx context.Context, input GradesInput, semester Semester) ([]SubjectGrades, error) {
	...
	if err != nil {
		...
		if errors.As(err, &e) {
			log.Errorf("%s/SemesterTotalGrades modeus error: %s", parserServicePrefixLog, e)
...
func (p *parser) Ratings(ctx context.Context, input GradesInput) (string, map[int]SemesterResult, error) {
	...
	if err != nil {
		var e *modeus.ErrModeusUnavailable
		if errors.As(err, &e) {
			log.Errorf("%s/Ratings modeus error: %s", parserServicePrefixLog, e)
			return "", nil, ErrModeusUnavailable
		}
...
func (p *parser) DayGrades(ctx context.Context, day time.Time, input GradesInput) ([]SubjectDayGrades, error) {
	...
	if err != nil {
		var e *modeus.ErrModeusUnavailable
		if errors.As(err, &e) {
			log.Errorf("%s/DayGrades modeus error: %s", parserServicePrefixLog, e)
			return nil, ErrModeusUnavailable
		}
	...
	for _, event := range schedule.Embedded.Events {
		...
		if e != nil {
			var er *modeus.ErrModeusUnavailable
			if errors.As(e, &er) {
				log.Errorf("%s/DayGrades modeus error: %s", parserServicePrefixLog, er)
				return nil, ErrModeusUnavailable
			}
...
func (p *parser) FindCurrentSemester(ctx context.Context, input GradesInput) (Semester, error) {
	...
	if err != nil {
		...
		var e *modeus.ErrModeusUnavailable
		if errors.As(err, &e) {
			log.Errorf("%s/FindCurrentSemester modeus error: %s", parserServicePrefixLog, e)
			return Semester{}, ErrModeusUnavailable
		}
...
func (p *parser) FindAllSemesters(ctx context.Context, input GradesInput) (map[string]Semester, error) {
	...
	if err != nil {
		var e *modeus.ErrModeusUnavailable
		if errors.As(err, &e) {
			log.Errorf("%s/FindAllSemesters modeus error: %s", parserServicePrefixLog, e)
			return nil, ErrModeusUnavailable
		}
...
func (p *parser) FindSemesterSubjects(ctx context.Context, input GradesInput, semester Semester) (map[string]string, error) {
	...
	if err != nil {
		var e *modeus.ErrModeusUnavailable
		if errors.As(err, &e) {
			log.Errorf("%s/FindSemesterSubjects modeus error: %s", parserServicePrefixLog, e)
			return nil, ErrModeusUnavailable
		}
...
func (p *parser) SubjectDetailedInfo(ctx context.Context, input GradesInput, semester Semester, subjectId string) (map[int]LessonGrades, error) {
	...
	if err != nil {
		var e *modeus.ErrModeusUnavailable
		if errors.As(err, &e) {
			log.Errorf("%s/SubjectDetailedInfo modeus error: %s", parserServicePrefixLog, e)
			return nil, ErrModeusUnavailable
		}
